...
<?php $component->withAttributes([]); ?>
    <div class="mb-8 flex justify-between items-end">
        ...
        <?php if(auth()->user()->isAdmin()): ?>
            <a href="<?php echo e(route('tasks.create')); ?>" class="hidden sm:inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-4 py-2.5 rounded-lg text-sm font-medium transition-colors shadow-sm shadow-blue-600/20">
        ...
        <div class="bg-white rounded-2xl p-6 shadow-sm border border-slate-200 hover:border-slate-300 hover:shadow-md transition-all relative overflow-hidden">
            ...
            <div class="flex items-center gap-4 relative z-10">
                ...
                <div>
                    ...
                    <p class="text-3xl font-bold text-slate-900"><?php echo e($totalTasks); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl p-6 shadow-sm border border-slate-200 hover:border-slate-300 hover:shadow-md transition-all relative overflow-hidden">
            ...
            <div class="flex items-center gap-4 relative z-10">
                ...
                <div>
                    ...
                    <p class="text-3xl font-bold text-slate-900"><?php echo e($pendingTasks); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl p-6 shadow-sm border border-slate-200 hover:border-slate-300 hover:shadow-md transition-all relative overflow-hidden">
            ...
            <div class="flex items-center gap-4 relative z-10">
                ...
                <div>
                    ...
                    <p class="text-3xl font-bold text-slate-900"><?php echo e($completedTasks); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl p-6 shadow-sm border border-slate-200 hover:border-slate-300 hover:shadow-md transition-all relative overflow-hidden">
            ...
            <div class="flex items-center gap-4 relative z-10">
                ...
                <div>
                    ...
                    <p class="text-3xl font-bold text-slate-900"><?php echo e($highPriorityTasks); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="lg:col-span-2">
            <div class="bg-white rounded-2xl p-6 shadow-sm border border-slate-200 h-full">
                <div class="flex justify-between items-center mb-6">
                    ...
                    <a href="<?php echo e(route('tasks.index')); ?>" class="text-sm font-medium text-blue-600 hover:text-blue-700 hover:underline inline-flex items-center">
                                    ...
                                    <tr class="hover:bg-slate-50 transition-colors group">
                                        <td class="py-3 px-4 align-top">
                                            <div class="sm:flex sm:items-center sm:justify-between">
                                                <div>
                                                    <a href="<?php echo e(route('tasks.show', $task)); ?>" class="font-medium text-slate-900 group-hover:text-blue-600 transition-colors">
                                                    ...
                                                    <div class="mt-1 flex items-center gap-2 text-xs text-slate-500">
                                                        <span class="inline-flex items-center gap-1">
                                                            ...
                                                            <?php echo e($task->assignedUser->name ?? 'Unassigned'); ?>
                                        ...
                                        <td class="py-3 px-4 align-top">
                                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium <?php echo e($task->status->badgeClass()); ?>">
                                                <?php echo e($task->status->label()); ?>

                                            </span>
                                        </td>
                                        <td class="py-3 px-4 align-top">
                                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium border border-transparent <?php echo e($task->priority->badgeClass()); ?>">
                                                <?php echo e($task->priority->label()); ?>

                                            </span>
                                        </td>
                                        <td class="py-3 px-4 align-top text-sm text-slate-600 hidden sm:table-cell">
                                            <div class="flex items-center gap-1.5 <?php echo e($task->due_date->isPast() && $task->status->value !== 'completed' ? 'text-red-600 shrink-0 font-medium' : ''); ?>">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (ctx) {
                const pending = <?php echo e($statusCounts['pending'] ?? 0); ?>;
                const inProgress = <?php echo e($statusCounts['in_progress'] ?? 0); ?>;
                const completed = <?php echo e($statusCounts['completed'] ?? 0); ?>;
...
<?php endif; ?>
<?php /**PATH C:\Users\ACER\OneDrive\Desktop\advi\Task-Management\task-manager\resources\views/dashboard.blade.php ENDPATH**/ ?>