    ...
    <div class="mb-6 flex flex-col sm:flex-row sm:justify-between sm:items-end gap-4">
        ...
        <div class="flex flex-wrap items-center justify-start sm:justify-end gap-3 isolate">
            <?php if(auth()->user()->can('update', $task)): ?>
                <a href="<?php echo e(route('tasks.edit', $task)); ?>" class="inline-flex items-center gap-2 px-4 py-2 bg-white text-slate-700 text-sm font-medium rounded-lg border border-slate-300 shadow-sm hover:bg-slate-50 transition-colors">
            ...
            <?php if(auth()->user()->can('delete', $task)): ?>
                <form method="POST" action="<?php echo e(route('tasks.destroy', $task)); ?>" onsubmit="return confirm('Are you sure you want to delete this task?');">
                    <?php echo csrf_field(); ?>
        ...
        <div class="lg:col-span-2 space-y-8">
            ...
            <div class="bg-white rounded-2xl p-6 shadow-sm border border-slate-200">
                ...
                <div class="prose max-w-none text-slate-600 whitespace-pre-line">
                    <?php echo e($task->description ?: 'No description provided for this task.'); ?>
                ...
                <?php if($task->ai_summary): ?>
                    <div class="space-y-4 relative z-10">
                        ...
                        <div>
                            ...
                            <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-semibold border bg-white shadow-sm <?php echo e($task->ai_priority?->badgeClass()); ?>">
                                <?php echo e($task->ai_priority?->label() ?? 'Not determined'); ?>

                            </span>
                            <?php if($task->ai_priority && $task->priority->value !== $task->ai_priority->value): ?>
            ...
            <div class="bg-white rounded-2xl p-6 shadow-sm border border-slate-200">
                ...
                <div class="space-y-5">
                    ...
                    <div>
                        ...
                        <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-semibold <?php echo e($task->status->badgeClass()); ?>">
                    ...
                    <div>
                        ...
                        <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-semibold border border-transparent <?php echo e($task->priority->badgeClass()); ?>">
                            <?php echo e($task->priority->label()); ?>
                    ...
                    <div>
                        ...
                        <div class="flex items-center gap-2 text-slate-800 font-medium bg-slate-50 p-2.5 rounded-lg border border-slate-100">
                            <svg class="w-5 h-5 <?php echo e($task->due_date->isPast() && $task->status->value !== 'completed' ? 'text-red-500' : 'text-slate-400'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>
                            <span class="<?php echo e($task->due_date->isPast() && $task->status->value !== 'completed' ? 'text-red-600' : ''); ?>">
                    ...
                    <div>
                        ...
                        <div class="flex items-center gap-3 bg-slate-50 p-2.5 rounded-lg border border-slate-100">
                            <div class="w-8 h-8 rounded-full bg-blue-100 text-blue-700 flex items-center justify-center text-xs font-bold shrink-0">
                                <?php echo e(substr($task->assignedUser->name ?? 'U', 0, 2)); ?>

                            </div>
                            <div class="min-w-0">
                                <p class="text-sm font-medium text-slate-900 truncate"><?php echo e($task->assignedUser->name ?? 'Unassigned'); ?></p>
                                <p class="text-xs text-slate-500 truncate"><?php echo e($task->assignedUser->email ?? ''); ?></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="pt-4 border-t border-slate-100 mt-2">
                        <div class="flex justify-between text-xs text-slate-400">
                            <span>Created:</span>
                            <span class="text-slate-600 font-medium"><?php echo e($task->created_at?->format('M d, Y H:i')); ?></span>
                        </div>
                        <div class="flex justify-between text-xs text-slate-400 mt-1.5">
                            <span>Last Updated:</span>
                            <span class="text-slate-600 font-medium"><?php echo e($task->updated_at?->diffForHumans()); ?></span>
                        </div>
                    </div>
                </div>
            </div>
...
<?php endif; ?>
<?php /**PATH C:\Users\ACER\OneDrive\Desktop\advi\Task-Management\task-manager\resources\views/tasks/show.blade.php ENDPATH**/ ?>