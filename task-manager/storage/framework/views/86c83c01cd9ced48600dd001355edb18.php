    ...
    <div class="flex flex-col lg:flex-row gap-8 items-start">
        ...
        <div class="flex-1 w-full flex flex-col items-center">
            <div class="main-card bg-white w-full max-w-3xl overflow-hidden flex flex-col">
                ...
                <form action="<?php echo e(route('tasks.update', $task)); ?>" method="POST" class="p-8 sm:p-12">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="mb-10">
                        <h2 class="text-[28px] font-extrabold text-slate-800 leading-tight mb-8"><?php echo e($task->title); ?></h2>
                        
                        <!-- Title Input Pill -->
                        <div class="relative group">
                            <input type="text" name="title" value="<?php echo e(old('title', $task->title)); ?>" placeholder="e.g. Launch New Campaign" class="form-input-pill pr-12 text-lg" required>
...
$message = $__bag->first($__errorArgs[0]); ?> <p class="text-red-500 text-xs mt-1 ml-4"><?php echo e($message); ?></p> <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-8 p-6 bg-slate-50 rounded-[20px] border border-slate-100 shadow-inner">
                        <textarea name="description" rows="3" class="w-full bg-transparent border-none focus:ring-0 text-slate-600 text-sm leading-relaxed placeholder:text-slate-300 resize-none" placeholder="Describe your task details here..."><?php echo e(old('description', $task->description)); ?></textarea>
                    </div>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="flex flex-col gap-4">
                            ...
                            <div class="flex flex-wrap items-center gap-3">
                                <div class="flex border border-slate-200 rounded-lg overflow-hidden h-9 shadow-sm">
                                    <button type="button" onclick="setPriority('low')" id="btn-low" class="px-5 text-sm font-semibold <?php echo e($task->priority->value === 'low' ? 'bg-blue-500 text-white' : 'bg-white text-slate-400'); ?> border-r border-slate-200">Low</button>
                            ...
                            <div class="flex flex-wrap gap-3">
                                <input type="hidden" name="priority" id="priority-input" value="<?php echo e(old('priority', $task->priority->value)); ?>">
                        ...
                        <div class="relative group">
                            ...
                            <input type="text" name="due_date" value="<?php echo e(old('due_date', $task->due_date->format('Y-m-d'))); ?>" placeholder="Due 2024-12-31" class="form-input-pill text-slate-400 bg-slate-50/50 border-slate-100 placeholder:text-slate-300" onfocus="(this.type='date')" onblur="(this.type='text')">
                        </div>
                                ...
                                <?php if(auth()->user()->isAdmin()): ?>
                                    <select name="assigned_to" class="form-input-pill appearance-none text-slate-400 bg-slate-50/50 border-slate-100 pr-10">
                                        <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($user->id); ?>" <?php echo e(old('assigned_to', $task->assigned_to) == $user->id ? 'selected' : ''); ?>><?php echo e($user->name); ?></option>
                ...
                <div class="flex flex-col w-full text-[15px] font-medium border-t border-gray-100">
                    <div class="border-b border-gray-100">
                        ...
                        <div id="task-sub" class="bg-[#3b82f6] text-white">
                             <a href="<?php echo e(route('tasks.index')); ?>" class="py-3.5 px-6 block">Tasks</a>
                        </div>
                    </div>
...
<?php /**PATH C:\Users\ACER\OneDrive\Desktop\advi\Task-Management\task-manager\resources\views/tasks/edit.blade.php ENDPATH**/ ?>