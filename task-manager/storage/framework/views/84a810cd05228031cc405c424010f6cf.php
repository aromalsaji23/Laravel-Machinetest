    ...
    <body class="font-sans antialiased bg-gray-50 text-gray-900">
        <div class="min-h-screen flex flex-col sm:flex-row">
            ...
            <nav class="w-full sm:w-64 bg-slate-900 text-white flex flex-col border-r border-slate-800 shrink-0 hidden sm:flex">
                <div class="p-6">
                    <a href="<?php echo e(route('dashboard')); ?>" class="text-2xl font-bold tracking-tight text-white flex items-center gap-2">
                ...
                <div class="px-4 py-2 flex-grow space-y-1">
                    <a href="<?php echo e(route('dashboard')); ?>" class="flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-medium <?php echo e(request()->routeIs('dashboard') ? 'bg-blue-600 text-white' : 'text-slate-300 hover:bg-slate-800 hover:text-white transition-colors'); ?>">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path></svg>
                        Dashboard
                    </a>
                    
                    <a href="<?php echo e(route('tasks.index')); ?>" class="flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-medium <?php echo e(request()->routeIs('tasks.*') ? 'bg-blue-600 text-white' : 'text-slate-300 hover:bg-slate-800 hover:text-white transition-colors'); ?>">
            ...
            <main class="flex-1 flex flex-col min-w-0 overflow-y-auto w-full">
                ...
                <div class="sm:hidden flex bg-slate-800 text-slate-300 px-2 py-3 gap-2 overflow-x-auto">
                    <a href="<?php echo e(route('dashboard')); ?>" class="px-3 py-1.5 rounded-md text-sm whitespace-nowrap <?php echo e(request()->routeIs('dashboard') ? 'bg-blue-600 text-white' : 'bg-slate-700'); ?>">Dashboard</a>
                    <a href="<?php echo e(route('tasks.index')); ?>" class="px-3 py-1.5 rounded-md text-sm whitespace-nowrap <?php echo e(request()->routeIs('tasks.*') ? 'bg-blue-600 text-white' : 'bg-slate-700'); ?>">Tasks</a>
                </div>
...
<?php /**PATH C:\Users\ACER\OneDrive\Desktop\advi\Task-Management\task-manager\resources\views/layouts/app.blade.php ENDPATH**/ ?>