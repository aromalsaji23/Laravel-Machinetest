...
class AIService
{
    ...
    /**
     * Calls Google Gemini API and parses JSON response
     */
    private function callGemini(string $prompt): array
    {
        ...
        $response = Http::post($url, [
            'systemInstruction' => [
                'parts' => [
                    ['text' => 'You are an AI task assistant. Always return valid JSON only.']
                ]
            ],
            'contents' => [
                [
        ...
        if (json_last_error() !== JSON_ERROR_NONE) {
            throw new Exception("Invalid JSON returned from Gemini: " . $content);
        }
